...
const defaults = () => ({
  ...
  tempo: { best: 0, bestSerie: 0, parties: 0, cadran: 3, bests: {} },   // Le Souffle court : meilleur score tout court, meilleure série, parties jouées, temps choisi (3, 5 ou 8 s) et meilleur score par temps
