...
export function uiMargins(kind = 'island') {
  ...
  if (kind === 'tempo') return !STAGE.compact ? { uiLeft: 60, uiRight: 60, uiTop: 120, uiBottom: 190, padding: 60 } : STAGE.portrait ? { uiLeft: 4, uiRight: 4, uiTop: 175, uiBottom: 160, padding: 12 } : { uiLeft: 20, uiRight: 20, uiTop: 80, uiBottom: 100, padding: 30 };   // en haut, la place du chronomètre ; en portrait, l'île prend toute la largeur (la tuile suit son bas, rien ne la gêne sur les côtés)
