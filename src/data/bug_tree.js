...
export const TREE = [
  {
    ...
    e: [
      { id: 'sprites', n: 'Sprites et décor', q: ['Quelle famille de tuiles ?', 'Une seule tuile ou toutes celles de sa famille ?'], e: [
        ...
        f('rare', 'Tuiles rares', 'Laquelle (moulin, chapelle, tour de guet, puits, campement, grenier, fontaine, auberge, abreuvoir, porche, mine, four à pain) ?', 'Elle s’affiche vide ou comme une prairie ?'),
        f('evenement', 'Tuiles d’événement', 'Marché, Fête ou Ruine à restaurer ?', 'L’image change-t-elle après son effet ?'),
      ...
      { id: 'effets', n: 'Météo et effets', q: ['Quel événement ou quel moment exactement ?'], e: [
        f('orage', 'Orage, pluie, éclair', 'Le voile reste-t-il après la fin ?', 'La pluie passe-t-elle devant le HUD ?'),
        f('canicule', 'Canicule', 'La chaleur tremblante est-elle là ?', 'Le voile ocre reste-t-il ?'),
        f('vent', 'Grand vent', 'Les rafales de feuilles traversent-elles l’île ?'),
        f('bourrasque', 'Bourrasque et neige', 'Les congères apparaissent-elles partout ?', 'Restent-elles après la fin ?'),
      ...
      { id: 'hud', n: 'HUD (ce qui s’affiche mal)', q: ['Téléphone tenu en portrait ou en paysage ?', 'Quel élément se chevauche ?'], e: [
        ...
        f('score', 'Compteur de points et jauge de série', 'Le badge « +N » déborde ?', 'La jauge est-elle lisible ?'),
...

  {
    ...
    e: [
      { id: 'pose', n: 'Points d’une pose', q: [], e: [
        ...
        f('prime', 'Prime de pose (eau, rivière, météo, climat)', 'Quelle prime attendue ?', 'Quel libellé dans le détail ?'),
        f('ruban', 'Le mot du ruban (Coup de maître, Il y avait mieux…)', 'Quel mot ?', 'Le coup te semblait meilleur ou pire ?'),
        f('serie', 'Jauge de série', 'À combien était-elle ?', 'As-tu eu le souffle à trois ?', 'La fermeture a-t-elle été doublée ?'),
      ...
      { id: 'regions', n: 'Régions et fermetures', q: [], e: [
        ...
        f('prime', 'La prime de fermeture', 'Quelle famille ?', 'Quelle prime reçue ?', 'Un porche ou une mine dedans ?'),
      ...
      { id: 'saisons', n: 'Saisons et règles de saison', q: [], e: [
        ...
        f('faucille', 'Faucille (clore la saison)', 'Quel niveau ?', 'Combien de poses restaient ?', 'Le bouton était-il actif ?'),
        autre('Quel problème de saison ?'),
      ] },
      { id: 'climat', n: 'Climat et météo', q: [], e: [
        ...
        f('orage', 'Orage', 'L’annonce est-elle apparue ?', 'Le +2 par rivière figurait-il ?'),
        f('canicule', 'Canicule', 'Quel voisinage avait ton pré (eau, puits, fontaine, abreuvoir, lande) ?'),
        f('vent', 'Grand vent', 'Le +3 des moulins est-il tombé la saison suivante ?'),
        f('bourrasque', 'Bourrasque', 'La file était-elle masquée ?', 'Pouvais-tu encore jouer ?'),
        f('redoux', 'Redoux', 'Les manchots sont-ils partis ?', 'L’eau est-elle redevenue liquide ?'),
        f('moment', 'Le moment du déclenchement', 'Combien de poses entre l’annonce et l’effet ?'),
        autre('Quel problème de climat ou de météo ?'),
      ] },
      ...
      { id: 'rares', n: 'Tuiles rares et tuiles d’événement', q: [], e: [
        f('famille', 'Ce pour quoi la rare compte', 'Laquelle ?', 'Pour quelle(s) famille(s) l’attendais-tu ?'),
        f('effet', 'L’effet d’une rare', 'Laquelle ?', 'Quel effet attendu (protection, bonus de bord, multiplicateur) ?'),
        f('marche', 'Marché', 'Le choix s’est-il ouvert ?', 'Pour combien de poses ?'),
        f('fete', 'Fête', 'Combien de hameaux voisins ?', 'Le bonus est-il retombé une deuxième fois ?'),
        f('ruine', 'Ruine à restaurer', 'En quelle famille s’est-elle transformée ?', 'Quelles familles autour ?'),
      ...
      { id: 'etoiles', n: 'Étoiles, graines, Atelier', q: [], e: [
        ...
        f('or', 'L’étoile d’or', 'Le seuil d’or était-il affiché ?', 'L’île brille-t-elle sur la carte ?'),
      ...
      { id: 'campagne', n: 'Campagne, chapitres, contrats', q: [], e: [
        ...
        f('contrat', 'Contrat d’archipel', 'Lequel ?', 'Combien comptés, combien attendus ?', 'As-tu rejoué l’île ?'),
...

  {
    ...
    e: [
      ...
      { id: 'depart', n: 'Écrans de départ d’île', q: [], e: [
        f('prep', 'Préparation d’île (nom, signature, contrat)', 'Quelle île ?', 'Le contrat affiché est-il celui signé ?'),
        f('semis', 'Choix du semis', 'Le choix est-il resté sélectionné ?'),
        f('contrat', 'Choix du contrat d’archipel', 'Quel chapitre ?', 'Le bouton reste-t-il grisé ?'),
