...

  {
    ...
    e: [
      ...
      { id: 'faune', n: 'Faune', q: ['Quelle espèce ?', 'Combien d’animaux étaient affichés ?'], e: [
        ...
        f('attache', 'Animaux liés à une fusion', 'Lequel ? Ceux-là ne rapportent pas de points, c’est voulu.'),
      ...
      { id: 'souffles', n: 'Souffles et pouvoirs', q: [], e: [
        ...
        f('defausse', 'Défausser (X)', 'Le coût affiché était-il bien 1 ?', 'La file s’est-elle rechargée ?'),
        f('souvenir', 'Annuler (Z)', 'Quel coût ?', 'L’avais-tu déjà utilisé cette saison ?', 'Tout est-il revenu ?'),
        autre('Quel pouvoir a mal réagi ?'),
      ] },
      { id: 'file', n: 'File et main', q: [], e: [
        f('file', 'La file de tuiles', 'Combien de tuiles voyais-tu ?', 'Quel niveau de Regard ?'),
        f('main', 'La main de saison (dès l’île 6)', 'La tuile cliquée a-t-elle été jouée ?', 'Un souffle a-t-il été débité à tort ?'),
        ...
        f('fin', 'La fin de la file', 'Restait-il une tuile en main ?', 'Restait-il une case libre ?'),
      ...
      { id: 'bilan', n: 'Fin d’île et bilan', q: [], e: [
        f('fin', 'L’île s’arrête trop tôt ou trop tard', 'Restait-il une case libre ?', 'Une tuile encore en main ?'),
...
export const CODE = {
  ...
  'regles/file': ['src/game/queue.js (tirage, main)'],
  'regles/batir': ['src/game/rules.js (bâtir, fusionner)', 'src/data/signatures.js', 'src/data/balance.js'],
