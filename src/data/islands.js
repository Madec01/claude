...
export const ISLANDS = [
  ...
  { id: 6,  arch: 2, cells: 60, starFactors: [2.9, 4.3, 5.4], seed: 2606, roughness: 0.4, holes: 1, seasonLength: 10, startSeason: 'summer', weights: W.farms, tilesRatio: 0.93, start: [{ q: 0, r: 0, family: 'hamlet' }, { q: 3, r: 0, family: 'hamlet' }, { q: -2, r: 2, family: 'rock' }], mechanics: ['rare'],
  ...
  { id: 7,  arch: 2, cells: 66, starFactors: [3.0, 4.3, 5.4], seed: 2707, roughness: 0.4, holes: 2, seasonLength: 10, startSeason: 'spring', weights: W.hills, tilesRatio: 0.92, start: [{ q: 0, r: 0, family: 'hamlet' }, { q: -3, r: 0, family: 'rock' }, { q: 2, r: 2, family: 'ruins' }], mechanics: ['hill'],
  ...
  { id: 8,  arch: 2, cells: 72, starFactors: [3.3, 4.8, 6.0], seed: 2808, roughness: 0.45, holes: 2, seasonLength: 9, startSeason: 'autumn', weights: W.ridges, tilesRatio: 0.92, start: [{ q: 0, r: 0, family: 'hamlet' }, { q: -4, r: 2, family: 'hamlet' }, { q: 3, r: -3, family: 'rock' }, { q: 1, r: 3, family: 'rock' }], mechanics: [],
  ...
  { id: 9,  arch: 3, cells: 84, starFactors: [3.4, 4.9, 6.2], seed: 3909, roughness: 0.45, holes: 2, seasonLength: 9, startSeason: 'spring', weights: W.moor, tilesRatio: 0.9, start: [{ q: 0, r: 0, family: 'hamlet' }, { q: -4, r: 1, family: 'rock' }, { q: 4, r: -2, family: 'rock' }, { q: 2, r: 3, family: 'rock' }, { q: -2, r: -2, family: 'ruins' }], mechanics: ['heath'],
  ...
  { id: 10, arch: 3, cells: 96, starFactors: [3.6, 5.3, 6.6], seed: 3010, roughness: 0.5, holes: 3, seasonLength: 9, startSeason: 'summer', weights: W.moorFarm, tilesRatio: 0.9, start: [{ q: 0, r: 0, family: 'hamlet' }, { q: 5, r: -1, family: 'hamlet' }, { q: -3, r: 3, family: 'rock' }, { q: -1, r: -4, family: 'rock' }], mechanics: [],
  ...
  { id: 11, arch: 3, cells: 108, starFactors: [3.8, 5.6, 7.0], seed: 3111, roughness: 0.5, holes: 3, seasonLength: 8, startSeason: 'autumn', weights: W.coastAll, tilesRatio: 0.9, start: [{ q: 0, r: 0, family: 'hamlet' }, { q: -5, r: 2, family: 'rock' }, { q: 4, r: 1, family: 'rock' }, { q: 0, r: -4, family: 'ruins' }, { q: 3, r: -4, family: 'hamlet' }], mechanics: [],
