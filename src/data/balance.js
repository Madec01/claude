...
export const BALANCE = {
  ...
  stars: { perCell: [4.4, 6.4, 8.0] },   // seuils par défaut (Île du jour) = cases × facteur ; les îles de campagne ont leurs `starFactors` calibrés (la 3e étoile exige aussi tous les vœux)
