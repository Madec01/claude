...
export const UPGRADES = [
  ...
  { id: 'frame', name: 'Charpente', icon: 'icon_tree', desc: 'Bâtir coûte un souffle de moins (le niveau 2 devient gratuit).', levels: ['Normal', '−1 souffle'], costs: [8], requires: 'build' },
  { id: 'seed2', name: 'Semence forte', icon: 'icon_leaf', desc: 'Une tuile de niveau 2 dans la file de départ de chaque île.', levels: ['Aucune', '1 tuile'], costs: [7], requires: 'build' },
