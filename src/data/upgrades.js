...
export const UPGRADES = [
  ...
  { id: 'sight', chapter: 1, name: 'Regard', icon: 'icon_info', desc: 'Voir plus loin dans la file de tuiles.', levels: ['3 tuiles', '4 tuiles', '5 tuiles'], costs: [4, 8] },
  ...
  { id: 'rare', chapter: 2, name: 'Semence rare', icon: 'icon_star', desc: 'Une tuile rare offerte au début de chaque île.', levels: ['Aucune', 'Puits', 'Moulin', 'Grenier', 'Fontaine'], costs: [6, 10, 12, 14], requires: 'rare' },
  ...
  { id: 'refuge', chapter: 3, name: 'Refuge', icon: 'icon_tree', desc: 'Chaque animal présent rapporte plus de points à chaque changement de saison.', levels: ['Normal', '+1 point', '+2 points'], costs: [5, 9], requires: 'fauna' },
  ...
  // chapitre 4 : bâtir
  { id: 'frame', chapter: 4, name: 'Charpente', icon: 'icon_tree', desc: 'Bâtir coûte un souffle de moins (le niveau 2 devient gratuit).', levels: ['Normal', '−1 souffle'], costs: [8], requires: 'build' },
  ...
  { id: 'memory', chapter: 4, name: 'Seconde chance', icon: 'icon_return', desc: 'Le souvenir (annuler) coûte moins de souffles.', levels: ['4 souffles', '3 souffles', '2 souffles'], costs: [4, 8], requires: 'breath' },
  // chapitre 5 : climats et fusions
  { id: 'still', chapter: 5, name: 'Alambic', icon: 'icon_drop', desc: 'La première fusion de chaque île ne coûte aucun souffle.', levels: ['Normal', '1re fusion offerte'], costs: [8], requires: 'fuse' },
  { id: 'cloak', chapter: 5, name: 'Manteau', icon: 'icon_sun', desc: 'La contrainte du climat s’adoucit : au chaud les prés ne sèchent plus dès le printemps, au froid les champs ne dorment qu’en hiver, à l’humide un hameau contre un marais ne perd que 1.', levels: ['Normal', 'Adouci'], costs: [10], requires: 'climate' },
  // chapitre 6 : ouvrages
  { id: 'talisman', chapter: 6, name: 'Talisman', icon: 'icon_star', desc: 'Commencer chaque île avec un ouvrage dans la file.', levels: ['Aucun', '1 ouvrage'], costs: [7], requires: 'work' },
  { id: 'shed', chapter: 6, name: 'Grande remise', icon: 'icon_pocket', desc: 'La remise garde deux ouvrages au lieu d’un.', levels: ['1 place', '2 places'], costs: [8], requires: 'work' },
  { id: 'fresh', chapter: 6, name: 'Fraîcheur', icon: 'icon_leaf', desc: 'Un ouvrage repris de la remise reste frais deux fois plus longtemps.', levels: ['4 poses', '8 poses'], costs: [7], requires: 'work' },
  // chapitre 7 : niveau 3
  ...
  { id: 'spyglass', chapter: 8, name: 'Longue-vue', icon: 'icon_info', desc: 'Encore plus loin dans la file, en plus du Regard.', levels: ['Normale', '+1 tuile', '+2 tuiles'], costs: [12, 16] },
