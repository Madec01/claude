...
export class Hud {
  ...
  destroy() { if (this._ro) this._ro.disconnect(); this.root.style.removeProperty('--queue-h'); (this.root.parentNode || document.documentElement).style.removeProperty('--hud-queue-h'); this.root.innerHTML = ''; }
}
