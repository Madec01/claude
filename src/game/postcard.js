...
export function renderPostcard(scene, { w = 1600, h = 1000 } = {}) {
  ...
  const saved = { cam: r.cam, transition: r.transition, weather: r.weather, hover: r.hover, flash: r.flash, nu: r.nu, _nu0: r._nu0, brume: r.brume };
  r.cam = cam; r.transition = null; r.weather = null; r.hover = null; r.flash = 0; r.brume = null;   // ni brume d'automne : la carte montre l'île entière
