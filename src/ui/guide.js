...
const TABS = {
  ...
  hand: { label: 'File, main et semis', build: () => h('div', {},
    ...
    h('p', { class: 'g-intro' }, 'Les prochaines tuiles sont visibles dans la file (trois, puis quatre ou cinq avec le Regard et la Longue-vue de l’Atelier). Avant l’île 16, la première est obligatoire : un souffle permet de l’échanger avec l’une des deux suivantes ou de la défausser.'),
    h('h3', {}, icon('icon_info'), `La main de saison (dès l’île ${mechIsland('hand')})`),
    h('p', { class: 'g-intro' }, 'Dès l’île 16, la file devient une main : on joue n’importe quelle tuile visible en cliquant dessus (ou touches 2 à 5), sans souffle. L’échange disparaît ; défausse, poche et bourgeon restent.'),
