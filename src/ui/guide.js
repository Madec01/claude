...
const TABS = {
  ...
  breath: { label: 'Souffles et vœux', build: () => h('div', {},
    ...
    h('p', { class: 'g-intro' }, `Les souffles sont une réserve de pouvoirs. On en gagne ${B.breaths.close} par région fermée, ${B.breaths.wish} par vœu exaucé et un pour ${B.breaths.faunaPer} animaux présents à chaque changement de saison. Ils sont rares : chaque pouvoir est un renoncement.`),
