...
export function buildPause({ onResume, onRestart, onOptions, onGuide, onFullscreen, onMenu, onPostcard = null, onReport = null, title, controls = true, kept = true }) {
  const root = h('div', { class: 'panel panel-pause' },
    ...
    controls ? h('div', { class: 'pause-controls' },
      ...
      h('div', {}, key('2 à 5'), h('span', {}, 'jouer une autre tuile de la main')),
      h('div', {}, key('X'), h('span', {}, 'défausser la tuile (1 souffle)')),
      h('div', {}, key('Z'), h('span', {}, 'annuler la dernière pose (3 souffles, une fois par saison)')),
    ...
    kept ? h('p', { class: 'pause-kept' }, 'Cette partie est gardée sur cet appareil : vous pouvez fermer le jeu et la reprendre depuis le menu.') : null,
  );
