...
| Collines à flancs bruns (« tuiles de falaises ») | Piste A retenue : sol d'herbe plat + collines, chaînes et monts en volume du pack EXTRA posés dessus, sommets recolorés par saison. Restent les pistes C (falaises côtières), D (détail de sommet), E (éboulis des massifs), et les monts pour les grands massifs de roche | fait (journal 102) — suites à décider |
