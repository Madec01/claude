...
| Collines à flancs bruns (« tuiles de falaises ») | Le sol de colline est la tuile surélevée `grass_17` du Hexagon Pack : un bloc hexagonal à flancs bruns, à arêtes droites, qui ne se fond pas. Pistes proposées au commanditaire : collines en volume du pack EXTRA (hill_single, hills, mountain — six modèles rendus en aperçu) sur un sol d'herbe plat ; relief par l'ombre ; falaises côtières ; détail de sommet ; éboulis des massifs | à trancher |
