...
case "$MODE" in
  court)   NAV="gate" ;;
  complet) NAV="autoplay mobile calm gate finale feel tempo pepin brume entrainement sw decouverte toucher resume fauna" ;;   # du plus long au plus court : le lot se remplit mieux
